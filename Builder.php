...
<h3 class="f_s_25 f_w_700 dark_text">Builder</h3>
</div>
...
<li class="nav-item">
<a class="nav-link active" id="Themes-tab" data-bs-toggle="tab" href="#Themes" role="tab" aria-controls="Themes" aria-selected="true">Themes</a>
</li>
<li class="nav-item">
...
<li class="nav-item">
<a class="nav-link" id="footer_tb-tab" data-bs-toggle="tab" href="#footer_tb" role="tab" aria-controls="aside" aria-selected="false">footer</a>
</li>
</ul>
</div>
</div>
