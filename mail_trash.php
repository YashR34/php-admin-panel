...
<p><a href="index-2.php">Dashboard</a> <i class="fas fa-caret-right"></i>Mail Trash</p>
</div>
</div>
</div>
</div>
...
<button data-bs-toggle="modal" data-bs-target="#exampleModalCenter" class="btn_1 w-100 mb-2 btn-lg email-gradient gradient-9-hover email__btn waves-effect"><i class="ti-plus"></i>COMPOSE</button>
<ul class="text-end mt-2">
<li><a href="#"><i class="ti-user"></i> <span> <span>Primary</span> </span> </a></li>
...
<li class=" active"><a href="#"><i class="ti-trash"></i> <span> <span>Trash</span> <span class="round_badge trash_mail">9</span> </span> </a></li>
</ul>
</div>
</div>
<div class="col-md-9">
...
<h3 class="m-0">Compose a email</h3>
</div>
...
<script src="vendors/calender_js/core/main.js"></script>
<script src="vendors/calender_js/interaction/main.js"></script>
<script src="vendors/calender_js/daygrid/main.js"></script>
<script src="vendors/calender_js/timegrid/main.js"></script>
<script src="vendors/calender_js/list/main.js"></script>
<script src="vendors/calender_js/activation.js"></script>
