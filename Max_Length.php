...
<h3 class="m-0">Default Usage</h3>
</div>
</div>
</div>
<div class="white_card_body">
<h6 class="card-subtitle mb-2">The badge will show up by default when the remaining chars are 25 or less:</h6>
...
<div class="box_header m-0">
<div class="main-title">
<h3 class="m-0">Threshold Value</h3>
</div>
</div>
</div>
<div class="white_card_body">
<h6 class="card-subtitle mb-2">Do you want the badge to show up when there are 20 chars or less? Use the <code>threshold</code> option:</h6>
...
<div class="box_header m-0">
<div class="main-title">
<h3 class="m-0">All the Options</h3>
</div>
</div>
</div>
<div class="white_card_body">
<h6 class="card-subtitle mb-2">This is a complete example where all the options configured for the bootstrap-maxlength counter are setted.</h6>
...
<div class="white_card_body">
<h6 class="card-subtitle mb-2">All you need to do is specify the placement option, with one of those strings. If none is specified, the positioning will be defauted to 'bottom'.</h6>
...
<div class="white_card_body">
<h6 class="card-subtitle mb-2">Bootstrap maxlength supports textarea as well as inputs.</h6>
