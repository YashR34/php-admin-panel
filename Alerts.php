...
<h3 class="m-0">Alerts With Background</h3>
</div>
</div>
</div>
...
<div class="alert-text">A simple <b>secondary</b> alert—check it out!</div>
</div>
<div class="alert text-white bg-success" role="alert">
<div class="alert-text">A simple <b>success</b> alert—check it out!</div>
</div>
<div class="alert text-white bg-danger" role="alert">
<div class="alert-text">A simple <b>danger</b> alert—check it out!</div>
</div>
<div class="alert text-white bg-warning" role="alert">
<div class="alert-text">A simple <b>warning</b> alert—check it out!</div>
</div>
<div class="alert text-white bg-info" role="alert">
<div class="alert-text">A simple <b>info</b> alert—check it out!</div>
</div>
</div>
</div>
</div>
...
<div class="box_header m-0">
<div class="main-title">
<h3 class="m-0">Background Alerts With Icons</h3>
</div>
</div>
</div>
<div class="white_card_body">
...
<div class="alert text-white bg-primary d-flex align-items-center" role="alert">
<div class="alert-icon me-2">
<i class="ti-alarm-clock"></i>
</div>
<div class="alert-text">A simple <b>primary</b> alert—check it out!</div>
</div>
<div class="alert text-white bg-secondary d-flex align-items-center" role="alert">
<div class="alert-icon me-2">
<i class="ti-alert"></i>
</div>
<div class="alert-text">A simple <b>secondary</b> alert—check it out!</div>
</div>
<div class="alert text-white bg-success d-flex align-items-center" role="alert">
<div class="alert-icon me-2">
<i class="ti-alarm-clock"></i>
</div>
<div class="alert-text">A simple <b>success</b> alert—check it out!</div>
...
<div class="alert text-white bg-info d-flex align-items-center" role="alert">
<div class="alert-icon me-2">
<i class="ti-alert"></i>
</div>
<div class="alert-text">A simple <b>info</b> alert—check it out!</div>
...
<div class="box_header m-0">
<div class="main-title">
<h3 class="m-0">Alerts Dismissing</h3>
</div>
</div>
</div>
<div class="white_card_body">
<div class="card-body">
<div class="card-body">
<p class="mb-4">Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever
</p>
<div class="alert text-white bg-primary d-flex align-items-center justify-content-between" role="alert">
<div class="alert-text">A simple <b>primary</b> alert—check it out!</div>
<button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button>
</div>
<div class="alert text-white bg-secondary d-flex align-items-center justify-content-between" role="alert">
<div class="alert-text">A simple <b>secondary</b> alert—check it out!</div>
<button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button>
</div>
