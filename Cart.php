...
<tbody>
<tr>
<td><img src="img/products/img-5.png" alt height="52">
<p class="d-inline-block align-middle mb-0"><a href class="d-inline-block align-middle mb-0 f_s_16 f_w_600 color_theme2">Reebok Beg</a><br><span class="text-muted font_s_13">size-08 (Model 2019)</span></p>
</td>
<td>$99</td>
<td><input class="form-control w-25" type="number" value="2" id="example-number-input1"></td>
<td>$198</td>
<td><a href class="text-dark"><i class="far fa-times-circle font_s_18"></i></a></td>
</tr>
<tr>
<td><img src="img/products/img-1.png" alt height="52">
<p class="d-inline-block align-middle mb-0"><a href class="d-inline-block align-middle mb-0 f_s_16 f_w_600 color_theme2">White Shoes</a><br><span class="text-muted font_s_13">size-06 (Model 2019)</span></p>
</td>
<td>$75</td>
<td><input class="form-control w-25" type="number" value="2" id="example-number-input2"></td>
<td>$150</td>
<td><a href class="text-dark"><i class="far fa-times-circle font_s_18"></i></a></td>
</tr>
<tr>
<td><img src="img/products/img-2.png" alt height="52">
<p class="d-inline-block align-middle mb-0"><a href class="d-inline-block align-middle mb-0 f_s_16 f_w_600 color_theme2">Lava Watch</a><br><span class="text-muted font_s_13">Pure Lether 100%(Model 2019)</span></p>
</td>
<td>$49</td>
<td><input class="form-control w-25" type="number" value="1" id="example-number-input3"></td>
<td>$49</td>
<td><a href class="text-dark"><i class="far fa-times-circle font_s_18"></i></a></td>
</tr>
<tr>
<td><img src="img/products/02.png" alt height="52">
<p class="d-inline-block align-middle mb-0"><a href class="d-inline-block align-middle mb-0 f_s_16 f_w_600 color_theme2">Important Shoes</a><br><span class="text-muted font_s_13">size-07 (Model 2019)</span></p>
</td>
<td>$99</td>
<td><input class="form-control w-25" type="number" value="1" id="example-number-input4"></td>
<td>$99</td>
<td><a href class="text-dark"><i class="far fa-times-circle font_s_18"></i></a></td>
</tr>
</tbody>
...
<label class="form-label" for="radio_1">Shipping Charge : $5.00</label>
</div>
</li>
<li>
<div class="radio radio-primary">
<input type="radio" name="radio" id="radio_2" value="option_2">
<label class="form-label" for="radio_2">Express Shipping Charge : $10.00</label>
</div>
</li>
