...
<h3 class="f_s_30 f_w_700 dark_text">Cart</h3>
<ol class="breadcrumb page_bradcam mb-0">
<li class="breadcrumb-item"><a href="javascript:void(0);">BitCrypto </a></li>
...
<div class="white_card_header border_bottom_1px"><h4 class="card-title mb-0">Order Summary</h4></div>
...
<p class="d-inline-block align-middle mb-0 product-name f_s_16 f_w_600 color_theme2">Reebok Shoes</p>
</td>
<td>2</td>
<td>$198</td>
</tr>
...
<p class="d-inline-block align-middle mb-0 product-name f_s_16 f_w_600 color_theme2">White Morden Camera</p>
</td>
<td>2</td>
<td>$150</td>
</tr>
<tr>
<td>
<img src="img/products/img-4.png" alt height="52" />
<p class="d-inline-block align-middle mb-0 product-name f_s_16 f_w_600 color_theme2">Lava Purse</p>
</td>
<td>1</td>
<td>$49</td>
</tr>
<tr>
<td>
<img src="img/products/02.png" alt height="52" />
<p class="d-inline-block align-middle mb-0 product-name f_s_16 f_w_600 color_theme2">Important Shoes</p>
</td>
<td>1</td>
<td>$99</td>
</tr>
...
<div class="col-lg-4">
<div class="white_card">
<div class="white_card_header border_bottom_1px"><h4 class="card-title mb-0">Delivery Address</h4></div>

<div class="card-body">
<div class="row mb-3">
<label class="form-label col-xl-3 col-lg-3 col-form-label">First Name</label>
<div class="col-lg-9 col-xl-8"><input class="form-control" type="text" id="firstname" /></div>
</div>
<div class="row mb-3">
<label class="form-label col-xl-3 col-lg-3 col-form-label">Last Name</label>
<div class="col-lg-9 col-xl-8"><input class="form-control" type="text" id="lastname" /></div>
</div>
<div class="row mb-3">
<label class="form-label col-xl-3 col-lg-3 col-form-label">Delivery Address</label>
<div class="col-lg-9 col-xl-8"><textarea class="form-control" rows="3"></textarea></div>
</div>
<div class="row mb-3">
<label class="form-label col-xl-3 col-lg-3 col-form-label">City</label>
<div class="col-lg-9 col-xl-8"><input class="form-control" type="text" id="city" /></div>
</div>
<div class="row mb-3">
<label class="form-label col-xl-3 col-lg-3 col-form-label">State</label>
...
<div class="row mb-3">
<label class="form-label col-xl-3 col-lg-3 col-form-label">Country</label>
<div class="col-lg-9 col-xl-8">
<select class="form-select">
<option>Select</option>
<option>India</option>
...
<div class="row mb-3">
<label class="form-label col-xl-3 col-lg-3 col-form-label">Zip Code</label>
<div class="col-lg-9 col-xl-8"><input class="form-control" type="text" /></div>
</div>
<div class="row mb-3">
...
<div class="row mb-3">
<div class="form-label col-lg-9 col-xl-8 offset-lg-3 offset-xl-3">
<div class="form-check custom-checkbox">
<input type="checkbox" class="form-check-input custom-control-input" id="horizontalCheckbox" data-parsley-multiple="groups" data-parsley-mincheck="2" />
<label class="form-check-label custom-control-label" for="horizontalCheckbox">Confirm Shipping Address</label>
</div>
</div>
</div>
</div>
...
<div class="col-lg-4">
<div class="white_card">
<div class="white_card_header border_bottom_1px"><h4 class="card-title mb-0">Billing Details</h4></div>

<div class="card-body">
<div class="accordion" id="accordionExample">
<div class="card border mb-1 shadow-none">
<div class="white_card_header border_bottom_1px custom-accordion" id="headingOne">
<a href class="text-dark d-flex justify-content-between" data-bs-toggle="collapse" data-bs-target="#collapseOne" aria-expanded="true" aria-controls="collapseOne">
<span class="align-self-center">Credit Card</span> <img src="img/card/card-2.png" alt height="30" />
</a>
</div>
...
<div class="col-md-4">
<div class=" mb-lg-0">
<label for="select_month" class="form-label">Expiry Month</label>
...
<div class="col-md-4">
<div class=" mb-lg-0">
<label for="select_year" class="form-label">Expiry Year</label>
...
<div class="col-md-4">
<div class="mb-lg-0">
<label class="form-label" for="CVV_Code">CVV Code</label>
...
<div class="white_card_header border_bottom_1px" id="headingTwo">
<a href class="text-dark d-flex justify-content-between collapsed" data-bs-toggle="collapse" data-bs-target="#collapseTwo" aria-expanded="false" aria-controls="collapseTwo">
<span class="align-self-center">Paypal</span> <img src="img/card/card-5.png" alt height="30" />
</a>
</div>
<div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionExample">
<div class="card-body"><p class="mb-0 text-muted">Add Paypal form page</p></div>
</div>
</div>
</div>
<button type="button" class="btn_1 mt-1 mb-1 w-100">PLACE YOUR ORDER</button>
</div>
